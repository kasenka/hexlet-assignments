...
class ApplicationTest {
    ...
    public void testShow() throws Exception {
        ...
        assertThatJson(body)
                .and(json -> json.node("title").isEqualTo(task.getTitle()),
    ...
    public void testUpdate() throws Exception {
        ...
        assertThat(task.getTitle()).isEqualTo(("12345"));
    }
    ...
    public void testDelete() throws Exception{
        ...
        var request = mockMvc.perform(delete("/tasks/" + task.getId()))
                .andExpect(status().isOk())
                .andReturn();
